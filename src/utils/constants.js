...
export const cardPosition = document.querySelector(".elements__cards"); //Переменная определения места вставки template-элемента (Проектная 5)
...
export const newCardImage = document.querySelector('.popup__input_type_name-place'); // Поиск поля ввода названия места для новой карточки (Проектная 5)
export const newCardLink = document.querySelector('.popup__input_type_link-place'); // Поиск поля ввода ссылки на фотодля новой карточки (Проектная 5)
...
export const profileName = document.querySelector(".profile__title"); // Поиск имени профиля на странице (Проектная 4)
export const profileJob = document.querySelector(".profile__subtitle"); // Поиск деятельности на странице (Проектная 4)
